...
import { GitHubNotifications, GitHubAggregated } from '../src/home/github-types';
...
describe('processNotifications', () => {
  ...
  it('filters out draft PRs', async () => {
    ...
    const notifications: GitHubNotifications = [];
    const pullRequests = [
      { url: 'https://api.github.com/repos/owner/repo/pulls/123', state: 'open', draft: true, body: '', base: { repo: { url: 'https://api.github.com/repos/owner/repo' } }, head: { repo: { url: 'https://api.github.com/repos/owner/repo' } } }
    ];
    const issues: any[] = [];
